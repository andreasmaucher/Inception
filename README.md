...
- Make
- Port 8443 available on your host

## Evaluation Notes

This project meets the 42 Inception evaluation requirements:
- ✅ Custom Dockerfiles (no pre-made images)
- ✅ Alpine Linux base images
- ✅ SSL/TLS encryption (TLSv1.2/TLSv1.3)
- ✅ Proper volume management
- ✅ Docker networking
- ✅ No prohibited patterns (tail -f, background processes, etc.)
- ✅ Proper entrypoint scripts with exec
